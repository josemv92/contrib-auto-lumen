...
use OpenTelemetry\Contrib\Instrumentation\Lumen\Contracts\Queue\TracingIsolated;
use OpenTelemetry\Contrib\Instrumentation\Lumen\Contracts\Queue\TracingLinked;
use OpenTelemetry\Contrib\Instrumentation\Lumen\Contracts\Queue\TracingParent;
...
class Worker implements LumenHook
{
    ...
    private function inheritsTracingInterface(Job $job, string $interface): bool
    {
        try {
            /**
             * We use $job->resolveName() which is the idiomatic Lumen way to get
