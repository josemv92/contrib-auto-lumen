...
namespace OpenTelemetry\Contrib\Instrumentation\Lumen\Hooks\Illuminate\Database\Eloquent;
...
class Model implements LumenHook
{
    use LumenHookTrait;
    use PostHookTrait;
        ...
        hook(
            ...
            pre: function ($builder, array $params, string $class, string $function, ?string $filename, ?int $lineno) {
                ...
                $builder = $this->instrumentation
                    ...
                    ->setAttribute('lumen.eloquent.model', $model::class)
                    ->setAttribute('lumen.eloquent.table', $model->getTable())
                    ->setAttribute('lumen.eloquent.operation', 'find');
        ...
        hook(
            ...
            pre: function (EloquentModel $model, array $params, string $class, string $function, ?string $filename, ?int $lineno) {
                $builder = $this->instrumentation
                    ...
                    ->setAttribute('lumen.eloquent.model', $model::class)
                    ->setAttribute('lumen.eloquent.table', $model->getTable())
                    ->setAttribute('lumen.eloquent.operation', 'update');
        ...
        hook(
            ...
            pre: function (EloquentModel $model, array $params, string $class, string $function, ?string $filename, ?int $lineno) {
                $builder = $this->instrumentation
                    ...
                    ->setAttribute('lumen.eloquent.model', $model::class)
                    ->setAttribute('lumen.eloquent.table', $model->getTable())
                    ->setAttribute('lumen.eloquent.operation', 'create');
        ...
        hook(
            ...
            pre: function (EloquentModel $model, array $params, string $class, string $function, ?string $filename, ?int $lineno) {
                $builder = $this->instrumentation
                    ...
                    ->setAttribute('lumen.eloquent.model', $model::class)
                    ->setAttribute('lumen.eloquent.table', $model->getTable())
                    ->setAttribute('lumen.eloquent.operation', 'delete');
        ...
        hook(
            ...
            pre: function ($builder, array $params, string $class, string $function, ?string $filename, ?int $lineno) {
                ...
                $builder = $this->instrumentation
                    ...
                    ->setAttribute('lumen.eloquent.model', $model::class)
                    ->setAttribute('lumen.eloquent.table', $model->getTable())
                    ->setAttribute('lumen.eloquent.operation', 'get')
        ...
        hook(
            ...
            pre: function (string $modelClassName, array $params, string $class, string $function, ?string $filename, ?int $lineno) {
                ...
                $builder = $this->instrumentation
                    ...
                    ->setAttribute('lumen.eloquent.model', $model::class)
                    ->setAttribute('lumen.eloquent.table', $model->getTable())
                    ->setAttribute('lumen.eloquent.operation', 'destroy');
        ...
        hook(
            ...
            pre: function (EloquentModel $model, array $params, string $class, string $function, ?string $filename, ?int $lineno) {
                $builder = $this->instrumentation
                    ...
                    ->setAttribute('lumen.eloquent.model', $model::class)
                    ->setAttribute('lumen.eloquent.table', $model->getTable())
                    ->setAttribute('lumen.eloquent.operation', 'refresh');
